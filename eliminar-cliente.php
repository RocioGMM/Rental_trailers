...
<form method="post" action="panel/b_cli.php?id=<?php echo $id;?>&tipo=<?php echo $tipo;?>" name="frmRegistro">
...
<div class="campitem-cliente">
    ...
    <div class="campb">
    <input type="hidden" name="id" value="<?php echo $id?>"/>Nombre:  <?php echo $row["contacto"];?> 
    </div>
    <div class="campb dospor">Empresa: <?php echo $row["nombre_empresa"];?> 
    
    </div>
  </div>
  
  <div class="campitem-cliente">    
    <div class="campb"> Domicilio: <?php echo $row["domicilio"];?></div>    
    <div class="campb dospor">Domicilio de la empresa: <?php	echo $row["domicilio_emp"]?>
    </div>
  </div>
  <div class="campitem-cliente">
    <div class="campb">Telefono:  <?php echo $row["telefono"];?> </div>
</div>
  <div class="save-btns">
    <div class="campc">
