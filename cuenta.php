...
<span class="titlesec">CUENTA</span>
</div>
...
if ($_SESSION["tipo"] != 'vendedor'){
    $vendedoract = $id;
        $sql2 = "SELECT * FROM evento ORDER BY fecha_captura DESC";
}else{
        $vendedoract = $_SESSION["vendedor"];
...
<span class="titlecol-ad ades" > VENTAS <?php //echo $row7["nombre"].' '.$row7["apellido"];?> </span> 

<div class="divline"></div>
<div id="stickem"></div>
  <div id="sticker">  
    <div class="time-s ti" ice:editable="*">VENTA</div>
...
<?php };     $veces_text = 1;   ?>
    ...
    <a <?php  if ($_SESSION["tipo"] != 'user'){?> href="agregar-venta.php?id=<?php echo $row2["id"];?>"<?php };?> target="_self">  
        <div class="time-s ti"><?php   echo $row2["evento"];// EVENTO?> </div>  
    </a>  

<?php       if($_SESSION["tipo"] == 'admin'){       ?>
    <div class="ic-idel"><a href="eliminar-evento.php?id=<?php echo $row2["id"];?>" target="_self"><img src="delete1.png" width="44" height="44" border="0" /></a></div>
<?php       };      ?>
...
<div class="ic-idel"><a href="agregar-venta.php?id=<?php echo $row5["id"];?>" target="_self"><img src="editaricon.png" width="44" height="44" border="0" /></a></div>
    <?php };?> 
