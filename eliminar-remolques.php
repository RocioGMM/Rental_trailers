...
<form method="post" action="panel/b_rem.php?id=<?php echo $id;?>&tipo=<?php echo $tipo;?>" name="frmRegistro">
<div class="onecol"><span class="titlecol-ad">Eliminar Remolque </span>
  

  <div class="campitem-cliente">
    <div class="campb"><input type="hidden" name="id" value="<?php echo $id?>"/>Numero:  <?php echo $row["numero"];?></div>
    <div class="campb dospor">Modelo: <?php echo $row["modelo"];?></div>
  </div>
  
  <div class="campitem-cliente">    
    <div class="campb"> Medidas: <?php echo $row["medidas"];?></div>       
    <div class="campb dospor">Capacidad: <?php	echo $row["capacidad"]?></div>
  </div>

  <div class="campitem-cliente">
    <div class="campb">Serie:  <?php echo $row["serie"];?> </div>
    <div class="campb dospor">Placas: <?php  echo $row["placas"]?></div>
  </div>
