...
<div class="onecol"><span class="titlecol-ad">Productos</span>
<form action="" method="post" class="cuscliform" >
  <input type="text" name="busclie" id="busclie" placeholder=" Buscar Producto" class="buscli1"/> 
  <input type="submit" name="add"  value="Buscar" class="buscli2"/>
</form>
<div class="icons-men"><a href="agregar-productos.php"><img src="add-user.png" width="64" height="42" /></a></div>
<div class="divline"></div>
  
  <div class="initem">
    <div class="t-uname">NOMBRE </div>
    <div class="t-uemail">CODIGO</div>
    <div class="t-contact">COSTO</div>
    <div class="t-contact">DESCRIPCION</div>
...
<?php 
      if($_POST["busclie"] != ''){
        ...
        $sql1 = "SELECT * FROM productos WHERE nombre like '%".$_POST["busclie"]."%' OR codigo like '%".$_POST["busclie"]."%' OR costo like '%".$_POST["busclie"]."%' OR descripcion like '%".$_POST["busclie"]."%' ORDER BY costo ASC";
      }else{
        $sql1 = "SELECT * FROM productos ORDER BY nombre ASC";
      };  		
...
?>
  <div class="initem"<?php if($row1["vendedor"] ==''){echo 'style="color:#FF0000 !important;"';};?>>
    ...
    <div class="uemail"><?php echo $row1["codigo"];?></div>
    <div class="contact"><?php echo $row1["costo"];?></div>
    <div class="contact"><?php echo $row1["descripcion"];?></div>
 
 
<div style="	float: right;	height: 37px;	width: 155px;	margin-top: 2px;	margin-bottom: 1px;"> 
<?php //if($_SESSION["tipo"] == 'admin'){?>
<div class="ic-idel"><a href="eliminar-productos.php?id=<?php echo $row1["id"];?>" target="_self"><img src="delete1.png" width="44" height="44" border="0" /></a></div>
<?php //};?>
<div class="ic-idel"><a href="agregar-productos.php?tipo=mod&id=<?php echo $row1["id"];?>"><img src="editaricon.png" width="44" height="44" border="0" /></a></div>
